...
public class MemoryInputStream
{
    ...
    public final int i32()
    {
        ...
        if (this.isLittleEndian) return Bytes.toIntegerLE(bytes, 0);
    ...
    {
        return Float.intBitsToFloat(this.i32());
    }
    ...
    {
        return new Vector2f(this.f32(), this.f32());
    }
    ...
    {
        return new Vector3f(this.f32(), this.f32(), this.f32());
    }
     ...
     */
    public final Vector4f v4()
    {
        return new Vector4f(this.f32(), this.f32(), this.f32(), this.f32());
    }
     ...
     * @return String read from the stream.
     */
    public final String cwstr()
    {
        int start = this.offset;
        int end = start;

        while (this.i16() != '\0') end += 2;

        return new String(this.buffer, start, end - start, StandardCharsets.UTF_16LE);
    }
    ...
    public UID uid()
    {
        ...
        return new UID(this.at(this.offset - 4 + value).cstr());
    }
    ...
    public String refstr()
    {
        ...
        return this.at(this.offset - 4 + value).cstr();
    }
}
